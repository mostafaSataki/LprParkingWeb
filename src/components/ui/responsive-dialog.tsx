  ...
  <ResponsiveDialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Responsive sizing
        responsive 
          ? "max-w-[95vw] max-h-[90vh] overflow-y-auto md:max-w-4xl lg:max-w-6xl" 
          : "max-w-lg",
        // Animation
...
ResponsiveDialogHeader.displayName = "DialogHeader"
...
ResponsiveDialogFooter.displayName = "DialogFooter"
