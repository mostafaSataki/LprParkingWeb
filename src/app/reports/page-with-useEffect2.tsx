  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card>
          <CardContent className="p-4">
            <h2 className="text-xl font-semibold mb-4">تست گزارش‌ها</h2>
            <p>اگر این متن را می‌بینید، یعنی گزارش‌ها با موفقیت بارگذاری شده‌اند.</p>
            {reportData && (
              <div className="mt-4">
                <p>کل درآمد: {toPersianNumeralsSimple(reportData.totalRevenue.toLocaleString())} تومان</p>
                <p>کل جلسات: {toPersianNumeralsSimple(reportData.totalSessions)}</p>
              </div>
            )}
          </CardContent>
        </Card>
